...
export const topSkaters: SkaterStat[] = [
  ...
  { player: "Adam Blanck", team: "Ghost Pirates", gamesPlayed: 22, goals: 29, assists: 18, points: 47 },
  ...
  { player: "Cam Czapski", team: "Ghost Pirates", gamesPlayed: 21, goals: 21, assists: 22, points: 43 },
